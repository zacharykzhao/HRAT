...
from EP_lib import random_generation
from HRAT.ComparisonAlgorithm.EvolutionaryAlg.EA_Utils import check_folder, cal_cost, laod_constraints
from EPACK_mamadroid_env import CFGModifierEnvMamadroidCons
from HRAT.ComparisonAlgorithm.EvolutionaryAlg.HACK_Mamadroid.HACK_mamadroid_Utils import trans2triple_rw
from libs_mamadroid import extract_feature, find_2nd_nn_l2
...
if __name__ == '__main__':
    date = "2011"
    save_folder = "evolutionary_programming_mamadroid_2011"
    ...
    for zidx, test_sha256 in enumerate(test_sha256_all):
        ...
        while count < 500:
            ...
            if count % 20 == 0:
                print("\tcurrent step：%d th %s" % (count, ACTION[action_type_list[0]]))
                print("\t", action_seq_list[0][0], ", ", action_seq_list[0][1], ", ", action_seq_list[0][2])
