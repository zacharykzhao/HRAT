...
from HC_env import HC_env

from HACK_Mal_Utils import load_train_data, load_all_test_data, trans2triple_rw

from HRAT.ComparisonAlgorithm.EvolutionaryAlg.EA_Utils import *
...
if __name__ == '__main__':
    ...
    save_folder = "hill_climbing_malscan_2011"
    ...
    for zidx, X_test_sha256 in enumerate(X_test_sha256_all):
        ...
        if os.path.exists(save_file_name):
            if len(open(save_file_name).readlines()) > 1:
                continue
        ...
        env = HC_env(X_test_triple, y_test,
