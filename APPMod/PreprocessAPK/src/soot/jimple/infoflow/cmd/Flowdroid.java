...
public class Flowdroid {
	...
	public static ArrayList<InfoflowResults> analyze(String[] args) throws Exception {
		exceptionFlag = false; // reset
		Flowdroid main = new Flowdroid();
		ArrayList<InfoflowResults> results = main.run(args);
		return results;
	}

	private ArrayList<InfoflowResults> run(String[] args) throws Exception {
		// output
		ArrayList<InfoflowResults> outputResults = new ArrayList<InfoflowResults>();
		...
		try {
			...
			// System.out.println(targetFile.getName()); // debug
