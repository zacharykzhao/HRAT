...
public class CombinedDUAnalysisTest {
    ...
    public static CombinedAnalysis v(final UnitGraph graph) {
        return new CombinedAnalysis() {
            final CombinedDUAnalysis combined = new CombinedDUAnalysis(graph);
            final SimpleLocalDefs defs = new SimpleLocalDefs(graph);
            final SimpleLocalUses uses = new SimpleLocalUses(graph, defs);
            final SimpleLiveLocals live = new SimpleLiveLocals(graph);
