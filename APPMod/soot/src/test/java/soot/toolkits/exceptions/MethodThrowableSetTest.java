...
public class MethodThrowableSetTest {
	...
	private static final String TARGET_CLASS = "soot.toolkits.exceptions.targets.MethodThrowableSetClass";
	private static final String EXCEPTION_CLASS = "soot.toolkits.exceptions.targets.MyException";
