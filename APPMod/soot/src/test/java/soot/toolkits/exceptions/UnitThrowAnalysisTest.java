...
public class UnitThrowAnalysisTest {
	...
	public void testJAssignStmt() {
		...
		assertTrue(ExceptionTestUtility.sameMembers(expectedRep, Collections.emptySet(),
				unitAnalysis.mightThrow(s)));
	...
	public void testGLookupSwitchStmt() {
		...
		Stmt s = Grimp.v().newLookupSwitchStmt(IntConstant.v(1), Arrays.asList(IntConstant.v(1)),
