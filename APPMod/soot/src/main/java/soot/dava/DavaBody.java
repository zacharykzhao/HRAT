...
public class DavaBody extends Body {
  ...
  private HashSet<Object> consumedConditions;
    private final HashSet<Object> thisLocals;

  private final IterableSet<ExceptionNode> synchronizedBlockFacts;
  private final IterableSet<ExceptionNode> exceptionFacts;
  private final IterableSet<AugmentedStmt> monitorFacts;

  private final IterableSet<String> importList;
  ...
  private final List<CaughtExceptionRef> caughtrefs;
