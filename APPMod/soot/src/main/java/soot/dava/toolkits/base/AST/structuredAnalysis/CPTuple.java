...
public class CPTuple {
  private final String sootClass; // hold the name of the class to which the val belongs .... needed for interprocedural constant
                            // Fields info

  /*
   *
   */
  private final CPVariable variable;
  ...
  public boolean equals(Object other) {
    if (other instanceof CPTuple) {
      ...
      if (isTop() || var.isTop()) {
        ...
        return sootClass.equals(var.getSootClassName()) && variable.equals(var.getVariable())
