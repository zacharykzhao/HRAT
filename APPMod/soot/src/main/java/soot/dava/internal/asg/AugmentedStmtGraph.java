...
public class AugmentedStmtGraph implements DirectedGraph<AugmentedStmt> {
  private final HashMap<Stmt, AugmentedStmt> binding;
  private final HashMap<AugmentedStmt, AugmentedStmt> original2clone;
  private final IterableSet<AugmentedStmt> aug_list;
  private final IterableSet<Stmt> stmt_list;
  private final List<AugmentedStmt> bheads;
    private final List<AugmentedStmt> btails;
    private final List<AugmentedStmt> cheads;
    private final List<AugmentedStmt> ctails;
