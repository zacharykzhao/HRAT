...
public class SootSig {
  ...
  private static final Map<Constructor<?>, String> constrCache = new ConcurrentHashMap<Constructor<?>, String>(); // TODO should be
                                                                                                            // a map with
                                                                                                            // soft keys,
                                                                                                            // actually
  private static final Map<Method, String> methodCache = new ConcurrentHashMap<Method, String>(); // TODO should be a map with soft
                                                                                            // keys, actually
