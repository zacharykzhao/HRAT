...
public class LabelAssigner {
  ...
  private final Map<Stmt, Label> stmtToLabel = new HashMap<Stmt, Label>();
  private final Map<Stmt, String> stmtToLabelName = new HashMap<Stmt, String>();

  private final Map<AbstractPayload, Label> payloadToLabel = new HashMap<AbstractPayload, Label>();
  private final Map<AbstractPayload, String> payloadToLabelName = new HashMap<AbstractPayload, String>();
