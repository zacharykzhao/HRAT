...
public class RegisterAllocator {
  ...
  private final Map<Local, Integer> localToLastRegNum;
  ...
  //
  private final List<Register> classConstantReg = new ArrayList<Register>();
  private final List<Register> nullConstantReg = new ArrayList<Register>();
  private final List<Register> floatConstantReg = new ArrayList<Register>();
  private final List<Register> intConstantReg = new ArrayList<Register>();
  private final List<Register> longConstantReg = new ArrayList<Register>();
  private final List<Register> doubleConstantReg = new ArrayList<Register>();
  private final List<Register> stringConstantReg = new ArrayList<Register>();
  ...
  private final Set<Register> lockedRegisters = new HashSet<Register>();
