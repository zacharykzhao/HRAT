...
public class StmtVisitor implements StmtSwitch {
  ...
  private final List<AbstractPayload> payloads;

  // maps used to map Jimple statements to dalvik instructions
  private final Map<Insn, Stmt> insnStmtMap = new HashMap<Insn, Stmt>();
  private final Map<Instruction, LocalRegisterAssignmentInformation> instructionRegisterMap
      = new IdentityHashMap<Instruction, LocalRegisterAssignmentInformation>();
  private final Map<Instruction, Insn> instructionInsnMap = new IdentityHashMap<Instruction, Insn>();
  ...
  private final Map<Instruction, AbstractPayload> instructionPayloadMap = new IdentityHashMap<Instruction, AbstractPayload>();
  private final List<LocalRegisterAssignmentInformation> parameterInstructionsList
      = new ArrayList<LocalRegisterAssignmentInformation>();

  private final Map<Constant, Register> monitorRegs = new HashMap<Constant, Register>();
