...
public class DalvikTyper implements IDalvikTyper {
  ...
  private final Map<ValueBox, Type> typed = new HashMap<ValueBox, Type>();
  private final Map<Local, Type> localTyped = new HashMap<Local, Type>();
  private final Set<Local> localTemp = new HashSet<Local>();
  private final List<LocalObj> localObjList = new ArrayList<LocalObj>();
  private final Map<Local, List<LocalObj>> local2Obj = new HashMap<Local, List<LocalObj>>();
