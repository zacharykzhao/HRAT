...
public class FieldSensitiveTestHelper {
	...
	private final Multimap<TestMethod, Statement> method2startPoint = HashMultimap.create();
	private final List<NormalEdge> normalEdges = Lists.newLinkedList();
	private final List<CallEdge> callEdges = Lists.newLinkedList();
	private final List<Call2ReturnEdge> call2retEdges = Lists.newLinkedList();
	private final List<ReturnEdge> returnEdges = Lists.newLinkedList();
	private final Map<Statement, TestMethod> stmt2method = Maps.newHashMap();
	private final Multiset<ExpectedFlowFunction> remainingFlowFunctions = HashMultiset.create();
	private final TestDebugger<String, TestFact, Statement, TestMethod> debugger;
	...
	public enum TabulationProblemExchange {AsSpecified, ExchangeForwardAndBackward}
