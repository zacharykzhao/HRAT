	...
	private class NNKey {
		...
		public boolean equals(Object obj) {
			...
			if (curr == null) {
				...
				return false;
			if (succ == null) {
                return other.succ == null;
			} else return succ.equals(other.succ);
        }
	}
	...
	private class CallKey {
		...
		public boolean equals(Object obj) {
			...
			if (destinationMethod == null) {
                return other.destinationMethod == null;
			} else return destinationMethod.equals(other.destinationMethod);
        }
	}
