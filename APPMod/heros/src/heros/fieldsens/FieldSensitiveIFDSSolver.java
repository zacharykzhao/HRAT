...
public class FieldSensitiveIFDSSolver<FieldRef, D, N, M, I extends InterproceduralCFG<N, M>> {
	...
	private final DefaultValueMap<M, MethodAnalyzer<FieldRef, D, N, M>> methodAnalyzers = new DefaultValueMap<M, MethodAnalyzer<FieldRef, D,N, M>>() {
		@Override
	...
	private final IFDSTabulationProblem<N, FieldRef, D, M, I> tabulationProblem;
