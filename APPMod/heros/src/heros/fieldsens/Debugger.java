...
public interface Debugger<Field, Fact, Stmt, Method> {
	...
	void askedToResolve(Resolver<Field, Fact, Stmt, Method> resolver, Constraint<Field> constraint);
	
	class NullDebugger <Field, Fact, Stmt, Method> implements Debugger<Field, Fact, Stmt, Method> {
