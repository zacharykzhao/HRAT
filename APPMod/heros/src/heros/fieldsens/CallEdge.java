...
public class CallEdge<Field, Fact, Stmt, Method> {
	...
	private final WrappedFact<Field, Fact, Stmt, Method> calleeSourceFact;
	private final PerAccessPathMethodAnalyzer<Field, Fact, Stmt, Method> callerAnalyzer;
	private final WrappedFactAtStatement<Field, Fact, Stmt, Method> factAtCallSite;
	...
	public boolean equals(Object obj) {
		...
		if (factAtCallSite == null) {
            return other.factAtCallSite == null;
		} else return factAtCallSite.equals(other.factAtCallSite);
    }
