...
public class SourceStmtAnnotatedMethodAnalyzer<Field, Fact, Stmt, Method>
	...
	private final DefaultValueMap<Key<Fact, Stmt>, PerAccessPathMethodAnalyzer<Field, Fact, Stmt, Method>> perSourceAnalyzer =
	...
	private final Synchronizer<Stmt> synchronizer;
