...
public abstract class Resolver<Field, Fact, Stmt, Method> {
	...
	private final Set<Resolver<Field, Fact, Stmt, Method>> interest = Sets.newHashSet();
	private final List<InterestCallback<Field, Fact, Stmt, Method>> interestCallbacks = Lists.newLinkedList();
