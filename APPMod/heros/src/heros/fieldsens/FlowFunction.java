...
public interface FlowFunction<FieldRef, D, Stmt, Method> {
	...
	class ConstrainedFact<FieldRef, D, Stmt, Method> {
		
		private final WrappedFact<FieldRef, D, Stmt, Method> fact;
		private final Constraint<FieldRef> constraint;
	...
	class ReadFieldConstraint<FieldRef> implements Constraint<FieldRef> {
