...
public class BiDiFieldSensitiveIFDSSolver<Field, Fact, Stmt, Method, I extends InterproceduralCFG<Stmt, Method>> {
	...
	private final FieldSensitiveIFDSSolver<Field, Fact, Stmt, Method, I> forwardSolver;
	private final FieldSensitiveIFDSSolver<Field, Fact, Stmt, Method, I> backwardSolver;
	private final Scheduler scheduler;
	private final SynchronizerImpl<Stmt> forwardSynchronizer;
	private final SynchronizerImpl<Stmt> backwardSynchronizer;
	...
	private static class SynchronizerImpl<Stmt> implements Synchronizer<Stmt> {
		...
		private final Set<Stmt> leakedSources = Sets.newHashSet();
		private final HashMultimap<Stmt, Runnable> pausedJobs = HashMultimap.create();
